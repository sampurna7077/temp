      ...
      <div data-testid="blog-section">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogResources.map((post) => (
            <Card key={post.id} className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border-0" data-testid={`blog-post-${post.slug}`}>
              {/* Featured Image */}
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <Badge className="bg-purple-100 text-purple-700 font-medium px-3 py-1 rounded-full border-0">
                    <FileText className="h-3 w-3 mr-1" />
                    BLOG POST
                  </Badge>
                  {post.category && (
                    <Badge variant="outline" className="text-slate-600 font-medium px-3 py-1 rounded-full border-slate-200">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                  ...
                  <Link href={`/resources/${post.slug}`}>
                    <Button 
                      variant="ghost" 
                      className="text-pink-500 hover:text-pink-600 font-medium p-0 h-auto hover:bg-transparent"
